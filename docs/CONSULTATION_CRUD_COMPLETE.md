...
```tsx
<Button size="sm" variant="secondary" onClick={() => onEditConsultation(consultation.id)}>
...
<div className="prose prose-sm max-w-none" dangerouslySetInnerHTML="{{" __html: notes }} />
```
